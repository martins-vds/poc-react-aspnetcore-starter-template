...
import { parseChallenges } from "./claimsUtils";
 ...
 * @returns 
 */
export const callApiWithToken = async (accessToken: string, apiEndpoint: string, account: AccountInfo) => {
 ...
 * @returns response
 */
export const handleClaimsChallenge = async (response: Response, apiEndpoint: string, account: AccountInfo) => {
